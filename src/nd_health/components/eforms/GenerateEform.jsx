...
const DynamicFormBuilder = () => {
  ...
  return (
    <Container>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateItem(sectionIndex, itemIndex, "required", e.target.checked)
                      }
                    />
                  }
                  label="Required"
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateItem(sectionIndex, itemIndex, "hidden", e.target.checked)
                      }
                    />
                  }
                  label="Hidden"
      ...
      <Button variant="contained" color="primary" startIcon={<Add />} onClick={addSection}>
        Add Section
      </Button>
      <Box mt={4}>
