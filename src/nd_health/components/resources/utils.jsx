...
export const formatDob = (input) => {
  ...
  if (truncatedInput.length >= 6) {
    return `${truncatedInput.slice(0, 4)}-${truncatedInput.slice(4, 6)}-${truncatedInput.slice(6)}`;
  } else if (truncatedInput.length >= 4) {
    return `${truncatedInput.slice(0, 4)}-${truncatedInput.slice(4)}`;
  } else {
...
export const formatHin = (input) => {
  ...
  if (truncatedInput.length > 6) {
    return `${truncatedInput.slice(0, 4)}-${truncatedInput.slice(4, 7)}-${truncatedInput.slice(7)}`;
