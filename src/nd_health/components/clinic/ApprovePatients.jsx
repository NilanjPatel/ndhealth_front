  ...
  const handleApprove = (row) => {
    ...
    const fetchApprove = async () => {
      ...
      if (data.statusCode === 200) {
        ...
        setDemographicList((prevList) => prevList.filter((prevRow) => prevRow.hin !== row.hin));
      } else {
                    ...
                    <Table>
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell style={{ fontWeight: "bold" }}>Alternative Phone</TableCell>
                      ...
                      <TableBody>
                        {demographicList.map((row) => (
                          <TableRow key={row.hin}>
                            ...
                            <TableCell>
                              {new Date(row.recordDate).toLocaleDateString("en-CA")}
                            </TableCell>
