...
import {formatPhone, isValidEmail} from '../components/resources/utils';
        ...
        return (
            <Layout clinicInfo={clinicInfo}>
                ...
                <Paper style={{
                    ...
                    <Typography variant="h6" gutterBottom style={{fontSize: '0.81rem', fontWeight: 'bold'}}>
                ...
                <Paper sx={{p: 2}}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6} style={{border: '1px'}}>
                            ...
                            <Grid item xs={12} md={6}>
                                <FormControl>
                                    ...
                                    <Select labelId='date-label' id='date' label="Select date" value={selectedDate}
                                            onChange={handleDateChange} style={{minWidth: '15rem'}}
                            ...
                            <Grid item xs={12} md={6}>
                                <FormControl>
                                    ...
                                    <Select labelId='time-label' id='time' label='Select time' value={selectedTime}
                                            onChange={handleTimeChange} style={{minWidth: '15rem'}}
                                            disabled={!isAppointmentAvailable}
                                    >
                                        {selectedDate &&
