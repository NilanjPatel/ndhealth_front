...
const featuresData = [
    ...
    },
    {
        ...
        description: 'Streamline appointment-related communications, saving valuable time and resources for your admin staff.',
        icon: call,
        image: image_1,
    },
    {
        title: 'Seamless Patient Communication',
        description: 'Connect effortlessly with patients using a user-friendly platform, enabling quick and efficient interactions with just one click.',
        icon: mail,
        image: image_1,
    },
    {
    ...
    },
    {
        ...
        description: 'Utilize our notification system to significantly reduce no-shows, enhancing overall appointment attendance for your clinic.',
        icon: alarm,
        image: image_1,
    },
];
    ...
    return (
        <Timeline position="alternate">
            {featuresData.map((feature, index) => (
                <TimelineItem key={index} sx={{minHeight: '100vh', display: 'flex', alignItems: 'center'}}>
